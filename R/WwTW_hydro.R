#' A data set of South Africa wastewater treatment works hydro information
#'
#' A data subset of South Africa wastewater treatment works hydro information. From a
#' global wastewater treatment plant database.
#' Reference paper: Ehalt Macedo, H., Lehner, B., Nicell, J. A., Grill, G., Li, J.,
#' Limtong, A., Shakya, R.: Distribution and characteristics of wastewater
#' treatment plants within the global river network. Earth System Science Data. 2022.
#' Column names:
